...
class User extends REST_Controller {
	...
	public function login_post()
	{
        ...
        $this->core_controller->add_return_data('user_login_data',$this->core_controller->add_return_data('session_token', $new_session_token['session_token']);
		add_return_data('session_token',$user_data)
